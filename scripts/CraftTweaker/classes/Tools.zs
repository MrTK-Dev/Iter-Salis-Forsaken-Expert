...
global tools as IIngredient[string] =
{
    ...
    pencil: <ore:artisansPencil>,
    tsquare: <ore:artisansTSquare>,
    ...
    shears: <ore:artisansShears>,
    punch: <ore:artisansPunch>,
    groover: <ore:artisansGroover>,
    mortar: <ore:artisansMortar>,
    knife: <ore:artisansKnife>,
    hatchet: <ore:artisansHatchet>,
    file: <ore:artisansFile>,
    solderer: <ore:artisanSolderer>
};